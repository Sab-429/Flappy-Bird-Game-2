let board;
    ...
    window.onload = function () {
      ...
      //music
      bgMusic = new Audio('/assets/game-music-loop-3-144252.mp3');
      bgMusic.loop = true; // makes it loop continuously
      bgMusic.volume = 0.5; // optional: set volume between 0 and 1

      gameOverSound = new Audio("/assets/game-over-arcade-6435.mp3");
